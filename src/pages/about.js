        ...
        <div className={styles.block}>
          ...
          <div className={styles.textBlock}>
            ...
            <p className={styles.text}>
              Hi! I'm Liz. I write speculative fiction about badass young women. I like books where romance takes a back seat,
              or just stays home. I enjoy creative world-building, humor, and characters who are nearly irredeemable. 
            </p>
            <p className={styles.text}>
