...
const SeriesBlock = ({image, alt, title, headlineOne, headlineTwo, cta, ctaMobile, button, link, hasBorder, isGif}) => {
    return (
        ...
        <div className={styles.button}>
            <BookButton text={cta} mobileText={ctaMobile} title={button} link={link}/>
        </div>
    </div>
    )
}
