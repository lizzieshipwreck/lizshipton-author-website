...
const about_liz_two = "My books balance dark humor and high-stakes action with worlds and characters rooted in my lived experience. I consider them satire before fantasy or romance, but I do like to lure you in with the sex and magic before I beat you over the head with the heavy stuff."
const about_liz_three = "Before I wrote books, I wrote code - so I've spent a lot of time interrogating systems. My books do it through the lens of sci-fantasy, but I write more directly on Substack about what it's like being an artist inside a system powered by algorithms instead of magic."
