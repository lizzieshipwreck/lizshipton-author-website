...
const about_liz_three = "If you're new to my books, start with Dot Slash Magic (explicit) or Mother & Slaughter. They have romantic subplots, but aren't considered 'romance' - for that, check out my MM pen name Hailey Reaves (explicit)."
