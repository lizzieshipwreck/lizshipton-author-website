...
const description_five = "Can he find Bird before the Exiters drag the world into inter-dimensional war? Does he even want to find her? And what is with this wall he can’t stop dreaming about?"

const quote_one = '"I literally cannot WAIT for this book." - Tik Tok';

const quote_two = '"SARGO!!!! YESSSSS" - Tik Tok'

const quote_three = '"I am so here for this" - Tik Tok'
